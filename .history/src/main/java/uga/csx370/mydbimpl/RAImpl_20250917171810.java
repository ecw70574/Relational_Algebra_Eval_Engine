...
public class RAImpl implements RA {
    ...
    public Relation intersect(Relation rel1, Relation rel2) {
        // TODO Auto-generated method stub
        // Check if two relations have the same schema (columns and types)
public void checkSchema(Relation rel1, Relation rel2) {
    // First: check same number of columns
    if (rel1.getAttrs().size() != rel2.getAttrs().size()) {
        throw new IllegalArgumentException("Relations are not compatible: different number of columns.");
    }
    ...
    // If no exception thrown, schemas match
}
    ...
    public Relation diff(Relation rel1, Relation rel2) {
        // TODO Auto-generated method stub
        //1. Check compatibility. Same # of rows/columns, attribute names, types in same order
